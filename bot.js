...
guild.channels.find('id', '485337917146005505').setName("S7Q Voice Online ["+rebel+"]");
  client.setInterval(() =>{
    let d = Date.now()
  }, 5000);
});
...
client.on("guildMemberAdd", (member) => {
    ...
    let channel = member.guild.channels.get("485352204627083294");
...
client.on('message', message => {
    if(message.content === '!'){
        message.channel.send('**Welcome To S7Q Clan..:champagne_glass:**')
    }
});
